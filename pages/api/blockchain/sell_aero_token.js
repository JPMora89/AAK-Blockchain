...
import { createAeroSwapInstance, provider ,createAeroInstance} from '../../../helpers/contractInstance/aeroSwapInstance';
...
export default async function handler(req, res) {
  if (req.method === 'POST') {
    ...
    const tokenContract = createAeroInstance(aeroAddress,signer)
    ...
    try {
      ...
      // Sell tokens
      const tx = await aeroSwapInstance.functions.sellTokens(numberOftokensinWei, {
        gasLimit: 5000000
      });
      await tx.wait();
